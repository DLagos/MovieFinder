package com.csc413.team7.meets.requests;
...
import com.csc413.team7.meets.Meet;
 ...
 */
public class JsonRequest extends Request<List<Meet>> {

    // Success listener implemented in controller
    private Response.Listener<List<Meet>> successListener;
    ...
    public JsonRequest(int method,
                       String url,
                       Response.Listener<List<Meet>> successListener,
    ...
    @Override
    protected Response<List<Meet>> parseNetworkResponse(NetworkResponse response) {
        ...
        try {
            ...
            movies = Meet.parseJson(jsonObject);
        }
    ...
    @Override
    protected void deliverResponse(List<Meet> movies) {
